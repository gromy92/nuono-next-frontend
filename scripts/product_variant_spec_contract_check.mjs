...
assertIncludes(specTable, 'onSaved?.(saved)', 'ProductVariantSpecTable close after save hook')
...
assertIncludes(specModal, "messageApi.success('保存成功')", 'ProductVariantSpecModal success feedback')
assertIncludes(specModal, 'window.setTimeout(closeModal, 0)', 'ProductVariantSpecModal lets success feedback mount before closing')
assertIncludes(specModal, 'onSaved={handleSaved}', 'ProductVariantSpecModal close after successful save')
