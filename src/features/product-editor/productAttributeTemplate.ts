...
import {
  ATTRIBUTE_UI_META,
  DUPLICATE_BASIC_CONTENT_CODES,
  DUPLICATE_CLASSIFICATION_GROUP_KEYS,
  HIDDEN_SELLER_ATTRIBUTE_CODES,
  OFFER_ONLY_ATTRIBUTE_CODES,
  VALID_FIELD_KINDS
} from './productAttributeTemplateConfig';
