...
assert.match(historySectionSource, /eventStatusLabel/)
assert.match(historySectionSource, /已发现/)
assert.match(historySectionSource, /已加入/)
assert.match(historySectionSource, /已移除/)
assert.match(historySectionSource, /已匹配/)
assert.match(historySectionSource, /有表现/)
assert.match(historySectionSource, /建议候选/)
