...
export const OPERATIONS_DASHBOARD_PATH = workspaceMenuPath('operations-dashboard')
...
export const SYSTEM_REPORT_STORE_DATA_PATH = workspaceMenuPath('system-report-store-data')
