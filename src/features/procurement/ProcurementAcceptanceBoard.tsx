...
import { ProcurementDemandList } from './ProcurementDemandList';
      ...
      <Card variant="borderless" style={{ border: '1px solid #dbe4ea' }}>
        ...
        {procurementState.status === 'success' ? (
          <Space direction="vertical" size={16} style={{ width: '100%' }}>
            ...
            <ProcurementDemandList
              demandItems={procurementState.data.demandItems}
              selectedDemandItemId={selectedProcurementItem?.id}
              onSelectDemandItem={onSelectDemandItem}
            />
          </Space>
        ) : null}
      </Card>
