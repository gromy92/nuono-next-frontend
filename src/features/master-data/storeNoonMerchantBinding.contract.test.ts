...
assert.match(storeBoardSource, /data-testid="store-create-project-code-input"/);
assert.doesNotMatch(storeBoardSource, /pendingCreateStoreProjects/);
assert.doesNotMatch(storeBoardSource, /store-create-project-select/);
assert.doesNotMatch(storeBoardSource, /projectList\?\./);
...
assert.doesNotMatch(storeTypesSource, /StoreBindingProjectOption/);
assert.doesNotMatch(storeTypesSource, /projectList\?:/);
...
assert.doesNotMatch(storeTypesSource, /orgCode\?:\s*string/);
assert.doesNotMatch(storeTypesSource, /orgName\?:\s*string/);
